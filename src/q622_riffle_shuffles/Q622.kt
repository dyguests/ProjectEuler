...
object Q622 {
    ...
    fun main(args: Array<String>) {
        ...
        find(8)
        println(MathUtils.splitFactors(MathUtils.pow(2, 60) - 1L))
        println(MathUtils.splitFactors(MathUtils.pow(2, 30) - 1L))
        println(MathUtils.splitFactors(MathUtils.pow(2, 15) - 1L))
...
object RiffleShuffles {
    fun sumOfN(times: Long): Long {
        ...
        val splitFactors = MathUtils.splitFactors(MathUtils.pow(2, times) - 1L)

//        [3, 3, 7, 11, 31, 151, 331]
//        val notOnlySpiltFactors = MathUtils.splitFactors(MathUtils.pow(2, 30) - 1L)
